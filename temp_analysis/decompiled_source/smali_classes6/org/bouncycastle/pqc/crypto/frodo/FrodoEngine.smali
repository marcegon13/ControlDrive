...
.method public kem_dec([B[B[B)V
    ...
    invoke-interface {v1, v3, v5, v2}, Lorg/bouncycastle/crypto/Xof;->doFinal([BII)I
...
.method public kem_enc([B[B[BLjava/security/SecureRandom;)V
    ...
    invoke-interface {v1, v3, v7, v2}, Lorg/bouncycastle/crypto/Xof;->doFinal([BII)I
...
.method public kem_keypair([B[BLjava/security/SecureRandom;)V
    ...
    invoke-direct {p0, v6, v1, v7, v3}, Lorg/bouncycastle/pqc/crypto/frodo/FrodoEngine;->matrix_add([S[SII)[S
    ...
    iget v1, v5, Lorg/bouncycastle/pqc/crypto/frodo/FrodoEngine;->len_pkh_bytes:I

    new-array v4, v1, [B

    iget-object v6, v5, Lorg/bouncycastle/pqc/crypto/frodo/FrodoEngine;->digest:Lorg/bouncycastle/crypto/Xof;

    array-length v7, p1

    invoke-interface {v6, p1, v2, v7}, Lorg/bouncycastle/crypto/Xof;->update([BII)V

    iget-object v6, v5, Lorg/bouncycastle/pqc/crypto/frodo/FrodoEngine;->digest:Lorg/bouncycastle/crypto/Xof;

    invoke-interface {v6, v4, v2, v1}, Lorg/bouncycastle/crypto/Xof;->doFinal([BII)I
    ...
    :goto_2
    iget v1, v5, Lorg/bouncycastle/pqc/crypto/frodo/FrodoEngine;->n:I
    ...
    iget v6, v5, Lorg/bouncycastle/pqc/crypto/frodo/FrodoEngine;->len_s_bytes:I

    iget v7, v5, Lorg/bouncycastle/pqc/crypto/frodo/FrodoEngine;->len_pk_bytes:I
    ...
    invoke-static {v1, v2, p2, v6, v8}, Ljava/lang/System;->arraycopy(Ljava/lang/Object;ILjava/lang/Object;II)V
