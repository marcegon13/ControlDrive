...
.method static constructor <clinit>()V
    ...
    const-string v2, "ownerUserActor"
...
.method public fromJson(Lcom/apollographql/apollo/api/json/JsonReader;Lcom/apollographql/apollo/api/CustomScalarAdapters;)Lexpo/modules/devlauncher/MeQuery$Account;
    ...
    .line 123
    :goto_0
    sget-object v4, Lexpo/modules/devlauncher/adapter/MeQuery_ResponseAdapter$Account;->RESPONSE_NAMES:Ljava/util/List;
    ...
    .line 131
    new-instance p2, Lexpo/modules/devlauncher/MeQuery$Account;

    if-eqz v1, :cond_1

    if-eqz v2, :cond_0

    invoke-direct {p2, v1, v2, v3}, Lexpo/modules/devlauncher/MeQuery$Account;-><init>(Ljava/lang/String;Ljava/lang/String;Lexpo/modules/devlauncher/MeQuery$OwnerUserActor;)V
    ...
    .line 126
    :cond_2
    sget-object v3, Lexpo/modules/devlauncher/adapter/MeQuery_ResponseAdapter$OwnerUserActor;->INSTANCE:Lexpo/modules/devlauncher/adapter/MeQuery_ResponseAdapter$OwnerUserActor;
    ...
    invoke-virtual {v3, p1, p2}, Lcom/apollographql/apollo/api/NullableAdapter;->fromJson(Lcom/apollographql/apollo/api/json/JsonReader;Lcom/apollographql/apollo/api/CustomScalarAdapters;)Ljava/lang/Object;

    move-result-object v3

    check-cast v3, Lexpo/modules/devlauncher/MeQuery$OwnerUserActor;
...
.method public final getRESPONSE_NAMES()Ljava/util/List;
    ...
    .line 115
    sget-object v0, Lexpo/modules/devlauncher/adapter/MeQuery_ResponseAdapter$Account;->RESPONSE_NAMES:Ljava/util/List;
...
.method public toJson(Lcom/apollographql/apollo/api/json/JsonWriter;Lcom/apollographql/apollo/api/CustomScalarAdapters;Lexpo/modules/devlauncher/MeQuery$Account;)V
    ...
    .line 149
    const-string v0, "ownerUserActor"

    invoke-interface {p1, v0}, Lcom/apollographql/apollo/api/json/JsonWriter;->name(Ljava/lang/String;)Lcom/apollographql/apollo/api/json/JsonWriter;

    .line 150
    sget-object v0, Lexpo/modules/devlauncher/adapter/MeQuery_ResponseAdapter$OwnerUserActor;->INSTANCE:Lexpo/modules/devlauncher/adapter/MeQuery_ResponseAdapter$OwnerUserActor;
